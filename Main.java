...
public class Main {
    public static void main(String[] args) {
        ...
        Cell r1c0 = new Cell("John");
        sheet1.setCellAt(1, 0, r1c0);
        Cell r2c0 = new Cell("Alan", Color.red);
        sheet1.setCellAt(2, 0, r2c0);
        Cell r3c0 = new Cell("Mary", Color.green);
        ...
        for (int i = 1; i < sheet1.getNumOfRows(); i++) {
            ...
            for (int j = 1; j < sheet1.getNumOfColumns() - 1; j++) {
               sum += sheet1.getCellAt(i, j).toInt();
            }
        ...
        // delete row
        sheet1.removeRow(2);
        System.out.println("remowe row N 2:");
        sheet1.printSheet();

        // delete column
        sheet1.removeColumn(4);
        System.out.println("remowe column N 4:");
        sheet1.printSheet();
    }
}
